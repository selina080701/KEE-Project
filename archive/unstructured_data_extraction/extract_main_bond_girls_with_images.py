# extract_main_bond_girls_with_images.py
...
# ---- Step 3: Main function to extract main Bond girls with images ----
def extract_main_bond_girls_with_images():
    ...
    output_file = output_dir / "bond_girls_with_images_test.csv"
...
if __name__ == "__main__":
    ...
    if bond_girls_df is not None:
        # Step 4: Apply data cleaning
        characters_csv = Path(__file__).parent.parent / "characters" / "all_movie_characters_with_image.csv"
