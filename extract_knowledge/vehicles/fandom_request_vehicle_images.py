# fandom_request_vehicle_images.py
...
def save_vehicle_images(csv_file):
    ...
    print(f"\n✓ Vehicle images saved to {output_file}")
...
if __name__ == "__main__":
    csv_file = Path("extract_knowledge/vehicles/all_movie_vehicles.csv")

    if not csv_file.exists():
        print(f"Error: {csv_file} not found!")
    else:
        save_vehicle_images(csv_file)